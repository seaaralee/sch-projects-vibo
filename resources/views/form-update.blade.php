                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('book.update', $book->id) }}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="input-field" name="judul" value="{{ $book-> judul}}">
                                                </div>
                                                <div class="form-group">
                                                    <label id="judul">Penulis</label>
                                                    <input type="text" id="input-field" name="penulis" value="{{ $book-> penulis}}">
                                                </div>
                                                <div class="form-group">
                                                    <label id="judul">Pengarang</label>
                                                    <input type="text" id="input-field" name="pengarang" value="{{ $book-> pengarang}}">
                                                </div>
                                                <div class="form-group">
                                                    <label id="judul">Penerbit</label>
                                                    <input type="text" id="input-field" name="penerbit" value="{{ $book-> penerbit}}">
                                                </div>
                                                <div class="form-group">
